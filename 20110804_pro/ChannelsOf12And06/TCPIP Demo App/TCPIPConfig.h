...
#define STACK_USE_DHCP_CLIENT           // Open DHCP client 
 ...
 */
	...
	#define MY_DEFAULT_HOST_NAME			"WYJS12FFFFCCT"
#elif defined(POWER_SUPPLY_6)
	#define MY_DEFAULT_HOST_NAME			"WYJS06FFFFCCT"
#endif

#define MY_DEFAULT_MAC_BYTE1            (0xFD) 
#define MY_DEFAULT_MAC_BYTE2            (0xFF)
#if defined(POWER_SUPPLY_12)||defined(POWER_SUPPLY_12_1602)
#define MY_DEFAULT_MAC_BYTE3            (0x12) 
#elif defined(POWER_SUPPLY_6)
#define MY_DEFAULT_MAC_BYTE3            (0x06) 
#endif
#define MY_DEFAULT_MAC_BYTE4            (0xD3)//CCT 12864  网，Y
#define MY_DEFAULT_MAC_BYTE5            (0xF8)
#define MY_DEFAULT_MAC_BYTE6            (0xCD)
...
#define MY_DEFAULT_GATE_BYTE4           (12ul)
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(1286ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		//	{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 200},
			...
			//{TCP_PURPOSE_BERKELEY_SERVER, TCP_ETH_RAM, 32, 32},                        //CCT这句话是有用的。它定义了套接字一次的收发字节数
			{TCP_PURPOSE_BERKELEY_CLIENT, TCP_ETH_RAM, 32, 32},
		};
